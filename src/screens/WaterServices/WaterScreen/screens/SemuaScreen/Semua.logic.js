...
//local import here
import SemuaNavigator from './Semua.navigator';
import {
  getAllUnitStatus,
  waterModalHandling,
...
const SemuaLogic = () => {
  //package value here
  const { navigator } = SemuaLogic.dependencies;
...
export default SemuaLogic;

SemuaLogic.dependencies = {
  navigator: SemuaNavigator,
};
