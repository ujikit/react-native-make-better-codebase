...
//local import here
import BelumNavigator from './Belum.navigator';
import {
  getAllUnitStatus,
  waterModalHandling,
...
const BelumLogic = () => {
  //package value here
  const { navigator } = BelumLogic.dependencies;
...
export default BelumLogic;

BelumLogic.dependencies = {
  navigator: BelumNavigator,
};
