...
//local import here
import styles from './TidakBerpenghuni.styles';
import TidakBerpenghuniLogic from './TidakBerpenghuni.logic';
...
const TidakBerpenghuniScreen = () => {
  //logic value here
  const { data, actions } = TidakBerpenghuniLogic();
