...
//local import here
import TidakBerpenghuniNavigator from './TidakBerpenghuni.navigator';
import {
  getAllUnitStatus,
  waterModalHandling,
} from '../../../../../redux/redux-actions';

const TidakBerpenghuniLogic = () => {
  //package value here
  const { navigator } = TidakBerpenghuniLogic.dependencies;
...
export default TidakBerpenghuniLogic;

TidakBerpenghuniLogic.dependencies = {
  navigator: TidakBerpenghuniNavigator,
};
